...
import org.apache.kafka.common.Time;
...
public class Login {
    ...
    public Login(final String loginContextName)
        ...
        // this.jaasConfig = AuthUtils.getConfiguration(jaasConfigFilePath);
        ...
        log.info("checking if its isKrbTicket");
        if (!isKrbTicket) {
            // if no TGT, do not bother with ticket management.
            return;
        }
        log.info("its a krb5ticket");
